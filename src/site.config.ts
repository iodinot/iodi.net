...
export const theme: ThemeUserConfig = {
  ...
  description: 'iodinot 的技术笔记与实践记录',
  ...
  logo: {
    src: 'https://github.com/iodinot.png',
    alt: 'iodinot 的头像'
  },
  ...
  footer: {
    ...
    social: { github: 'https://github.com/iodinot' }
  },
...
export const integ: IntegrationUserConfig = {
  ...
  links: {
    ...
    applyTip: [
      ...
      { name: 'Link', val: 'https://iodi.net' },
      { name: 'Avatar', val: '/favicon/favicon.png' }
    ],
  ...
  waline: {
    enable: false,
    // Server service link
    server: 'https://review.awfufu.com/',
    // Refer https://waline.js.org/en/guide/features/emoji.html
    emoji: ['qq', 'bmoji', 'tieba'],
